...
export default function LandingPage() {
  ...
  return (
    // STYLE CHUYÊN NGHIỆP: Nền trắng + Grid mờ (Thay vì nền xanh lè)
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-cyan-100 selection:text-cyan-900 overflow-x-hidden">
      ...
      {/* --- BACKGROUND PATTERN: Dot Grid tinh tế --- */}
          ...
          <div className="flex items-center gap-4">
            {!loading && user ? (
              <div className="flex items-center gap-3">
                 <Link href="/dashboard" className="hidden sm:flex text-sm font-medium text-slate-600 hover:text-cyan-600 transition-colors">
                    Dashboard
                 </Link>
      ...
      {/* --- HERO SECTION: Tập trung vào Value, bớt màu mè --- */}
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2 text-center lg:text-left space-y-8">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
              Eloqua isn't just a spellchecker. It's an AI-powered writing coach that analyzes your logic, vocabulary, and coherence to help you reach <span className="font-semibold text-slate-900">IELTS Band 8.0+</span> standards.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Link href="/analyze" className="inline-flex justify-center items-center gap-2 px-8 py-4 bg-cyan-600 text-white font-semibold rounded-xl hover:bg-cyan-700 transition-all hover:scale-[1.02] shadow-xl shadow-cyan-600/20">
                Analyze My Writing <ArrowRight size={18} />
              </Link>
              <Link href="#demo" className="inline-flex justify-center items-center gap-2 px-8 py-4 bg-white border border-slate-200 text-slate-700 font-semibold rounded-xl hover:border-slate-300 hover:bg-slate-50 transition-all">
                View Demo
              </Link>
            </div>
          ...
          {/* Right Visual: Interactive UI Mockup (Thay vì hình tĩnh) */}
          <div className="lg:w-1/2 w-full relative">
            ...
            <div className="relative bg-white rounded-xl border border-slate-200 shadow-2xl overflow-hidden">
               ...
               <div className="h-10 border-b border-slate-100 bg-slate-50 flex items-center px-4 gap-2">
                  ...
                  <div className="ml-4 px-3 py-1 bg-white rounded text-[10px] font-mono text-slate-400 border border-slate-100">gemini_latest_model</div>
               </div>
               ...
               <div className="grid grid-cols-2 min-h-[360px] divide-x divide-slate-100">
                  ...
                  <div className="p-6 font-serif text-slate-500 leading-loose text-sm">
                    ...
                    The graph <span className="bg-red-50 text-red-600 border-b border-red-200 decoration-red-400 px-0.5">shows the amount of people</span> who use the internet in 2020. I think it is very big number.
                  </div>
                  ...
                  <div className="p-6 bg-cyan-50/30 font-serif text-slate-800 leading-loose text-sm">
                    ...
                    The graph <span className="bg-green-100 text-green-800 border-b border-green-300 px-0.5">illustrates the number of individuals</span> accessing the internet in 2020. This figure is significantly high.
                  </div>
               </div>

               {/* Mockup Floating Badge */}
               <div className="absolute bottom-6 right-6 bg-slate-900 text-white px-4 py-2 rounded-lg text-xs font-bold shadow-lg flex items-center gap-2">
                  <div className="w-2 h-2 rounded-full bg-green-400 animate-pulse"/>
                  Vocabulary Score: 8.5
               </div>
            </div>
          </div>
        </div>
